...
- It now emits authored CSD cast transform, keyframe curve, keyframe sample, and sampled transform descriptors for a first exact-family sample set, but it still does not drive full CSD animation playback.
