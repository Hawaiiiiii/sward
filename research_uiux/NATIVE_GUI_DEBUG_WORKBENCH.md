...
- It now has Asset View plus atlas-sheet gallery navigation and CSD element navigation, but this is not yet a full DDS/subimage browser.
...
- It now emits authored CSD cast transform, keyframe curve, keyframe sample, sampled transform, sampled draw-command, sampled channel-state, sampled channel-evaluation descriptors, and navigable Asset View CSD element bindings for a curated exact/proxy sample set, but it still does not drive full CSD animation playback.
...
2. Turn navigable CSD element bindings into crop/rect previews.
