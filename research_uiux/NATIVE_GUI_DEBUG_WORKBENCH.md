...
- It now emits authored CSD cast transform and keyframe curve descriptors for a first exact-family sample set, but it still does not interpolate full CSD animation curves.
