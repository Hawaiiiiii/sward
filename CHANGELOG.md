...
- drew the first authored sampled transform markers in the native GUI preview panel
- reused authored cast rectangles plus sampled X/Y keyframes for Title and Loading exact-family marker geometry
- added `--authored-sampled-transform-preview-smoke`, verifying preview marker geometry under `b/rr75`
...
- added exact-family authored CSD keyframe sample descriptors to the GUI detail path
- stored bounded keyframe points for the Title, Pause, and Loading samples and added a deterministic linear sampler
- added `--authored-keyframe-sample-smoke`, verifying sampled Title, Pause, and Loading authored keyframe values under `b/rr73`
...
- added exact-family authored CSD cast transform descriptors to the GUI detail path
- bound parsed `layout_deep_analysis.json` cast evidence for Title, Pause, and Loading into renderer-facing transform descriptors
- added `--authored-cast-transform-smoke`, verifying Title, Pause, and Loading authored cast descriptors under `b/rr71`
