...
- It now has Asset View plus atlas-sheet gallery navigation, CSD element navigation, selected-element crop previews, and selected cast/subimage descriptors, but this is not yet a full DDS/subimage browser.
...
- It now emits authored CSD cast transform, keyframe curve, keyframe sample, sampled transform, sampled draw-command, sampled channel-state, sampled channel-evaluation descriptors, navigable Asset View CSD element bindings, selected-element crop descriptors, and selected cast/subimage draw descriptors for a curated exact/proxy sample set, but it still does not drive full CSD animation playback.
...
2. Turn selected cast/subimage descriptors into exact subimage/cast draw commands.
