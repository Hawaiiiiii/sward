// DECOUPLED from UnleashedRecomp/ui/tv_static.cpp — game includes (decompressor /
// gpu/video / aspect patches / embedded DDS) -> the shim + render contract; the two
// static-noise sprites load via render::LoadUISprite. Body byte-identical.
#include "tv_static.h"
...
static std::unique_ptr<sgfx::render::Texture> g_flashTexture;
static std::unique_ptr<sgfx::render::Texture> g_noiseTexture;
...
void TVStatic::Init()
{
    g_flashTexture = sgfx::render::LoadUISprite(sgfx::render::UISprite::OptionsStaticFlash);
    g_noiseTexture = sgfx::render::LoadUISprite(sgfx::render::UISprite::OptionsStatic);
}
