...
// DECOUPLED from UnleashedRecomp/ui/imgui_utils.h: gpu/imgui/imgui_common.h +
// gpu/video.h (GuestTexture) -> the lib's render contract; standard headers the game
// headers used to pull in transitively are now explicit. Function declarations below
// are UNCHANGED from the recomp.
#include <memory>
#include <string>
#include <string_view>
#include <vector>
...
#include "../render/sgfx_render.h"   // Dear ImGui + the gradient/outline contract + render::Texture
...
extern std::unique_ptr<sgfx::render::Texture> g_texGeneralWindow;
extern std::unique_ptr<sgfx::render::Texture> g_texLight;
extern std::unique_ptr<sgfx::render::Texture> g_texSelect;
