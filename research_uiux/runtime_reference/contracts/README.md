...
This directory contains the Phase 27/37/39/42/45 portable runtime contract files consumed by the native C++ runtime, the C ABI layer, and the C# reference port.
