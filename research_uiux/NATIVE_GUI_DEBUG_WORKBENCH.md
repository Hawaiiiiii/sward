...
- draws first-pass CSD element-binding cues in Asset View for Title, Pause, Loading, and gameplay-HUD proxy families
...
- It now has Asset View plus atlas-sheet gallery navigation and first CSD element-binding cues, but this is not yet a full DDS/subimage browser.
...
- It now emits authored CSD cast transform, keyframe curve, keyframe sample, sampled transform, sampled draw-command, sampled channel-state, sampled channel-evaluation descriptors, and first Asset View CSD element bindings for a curated exact/proxy sample set, but it still does not drive full CSD animation playback.
...
2. Turn CSD element bindings into navigable scene/cast/subimage selection and crop previews.
