...
- It now emits authored CSD cast transform, keyframe curve, and keyframe sample descriptors for a first exact-family sample set, but it still does not drive full CSD animation playback.
