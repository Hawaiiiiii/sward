...
int main(int argc, char** argv) {
    ...
    if (soak) {
        ...
        audio::Shutdown(); ui::Shutdown(); viewer3d::LiveStop(); gfx::shutdown(); SDL_DestroyWindow(win); SDL_Quit();
        return 0;
    }
    ...
    if (shot) {
        ...
        csd::Unload(); ui::Shutdown(); viewer3d::LiveStop(); gfx::shutdown(); SDL_DestroyWindow(win); SDL_Quit();
        return 0;
    }
